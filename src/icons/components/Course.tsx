  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
      <g clip-path="url(#clip0_15_47)">
        ...
        <path d="M13.98 11.01C13.66 11.01 13.37 10.81 13.27 10.49C13.14 10.1 13.36 9.66998 13.75 9.54998C15.29 9.04998 17.28 8.88998 19.11 9.09998C19.52 9.14998 19.82 9.51998 19.77 9.92998C19.72 10.34 19.35 10.64 18.94 10.59C17.32 10.4 15.55 10.55 14.21 10.98C14.13 10.99 14.05 11.01 13.98 11.01Z" fill="url(#paint1_linear_15_47)" />
      ...
      <defs>
        ...
        <linearGradient id="paint1_linear_15_47" x1="16.504" y1="9.00989" x2="16.504" y2="11.01" gradientUnits="userSpaceOnUse">
          <stop stop-color="#B6F829" />
          <stop offset="1" stop-color="#67DD0A" />
        </linearGradient>
        <linearGradient id="paint2_linear_15_47" x1="16.504" y1="11.6699" x2="16.504" y2="13.67" gradientUnits="userSpaceOnUse">
          <stop stop-color="#B6F829" />
          <stop offset="1" stop-color="#67DD0A" />
        </linearGradient>
